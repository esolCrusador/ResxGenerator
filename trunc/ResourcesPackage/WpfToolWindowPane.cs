...
namespace GloryS.ResourcesPackage
{
    public abstract class WpfToolWindowPane : ToolWindowPane
    {
        ...
        public WpfToolWindowPane()
            : base(null)
        {
            GlobalServiceProvider = (IServiceProvider)Microsoft.VisualStudio.Shell.Package.GetGlobalService(typeof(IServiceProvider));
            if (GlobalServiceProvider == null)
            {
                GlobalServiceProvider = new ServiceProvider((Microsoft.VisualStudio.OLE.Interop.IServiceProvider) Microsoft.VisualStudio.Shell.Package.GetGlobalService(typeof (Microsoft.VisualStudio.OLE.Interop.IServiceProvider)));
            }
        }
        ...
        public override object Content
        {
            get
            {
                return CreateToolWindowControl();
            }
        }
        ...
        public static void ProvideToolWindowCommand<TToolWindowPane>(Package package, Guid menuGroup, int commandId)
