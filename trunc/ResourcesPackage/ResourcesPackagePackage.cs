...
namespace GloryS.ResourcesPackage
{
    ...
    [Guid(GuidList.guidResourcesPackagePkgString)]
    public sealed class ResourcesPackagePackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidResourcesPackageCmdSet, (int)PkgCmdIDList.ResourcesPackage);
